...
<div class="pics">
    <div class="Bali">
        ...
        <h1 class="Bali"><a href="bookingPage.php" class="font">Bali</a><br><h2 class="Bali">$1500</h2></h1>
    ...
    <div class="Phuket">
        ...
        <h1 class="Phuket"><a href="bookingPage.php" class="font">Phuket</a> <br><h2 class="Phuket">$1350</h2></h1>
        <input type="button" value="Add to wishlist ♥" class="atw" onclick="showAlert2()" name="Phuket">
    </div>
    
    <div class="Delhi">
        <img src="delhi.jpg" alt="Delhi" class="img3">
        <h1 class="Delhi"><a href="bookingPage.php" class="font">Delhi</a> <br><h2 class="Delhi">$1200</h2></h1>
        <input type="button" value="Add to wishlist ♥" class="atw" onclick="showAlert3()" name="Delhi">
    </div>
    
    <div class="Male">
        <img src="male.jpg" alt="Male" class="img4">
        <h1 class="Male"><a href="bookingPage.php" class="font">Male</a> <br><h2 class="Male">$1650</h2></h1>
